    ...
    <section>
        ...
        <div class="plan-card-left">
            ...
            <ul class="plan-features">
                <li class="plan-feature light">Book organization</li>
                <li class="plan-feature"><a>Up to 5000 items</a></li>
                <li class="plan-feature light">Wishlist sharing</li>
                <li class="plan-feature"><a>Share your wishlist with friends and family</a></li>
                <li class="plan-feature light">Reading Progress</li>
                <li class="plan-feature"><a>Mark books as "currently reading"</a></li>
                <li class="plan-feature light">Filtering Options</li>
